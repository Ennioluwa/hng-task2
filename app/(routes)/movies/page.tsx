...
const MoviesPage = async () => {
  const { data: movies } = await axios.get(
    `https://api.themoviedb.org/3/movie/popular?language=en-US&page=1&api_key=d4c3f3ba31798ade4a6c41b6a29bef60`
  );
  return (
    <div className="">
      <div className="px-5 sm:px-10 container mx-auto">
        <div className="flex justify-between items-center pt-[70px] mb-10">
          <h3 className=" font-bold text-2xl sm:text-4xl">Movies</h3>
        </div>
